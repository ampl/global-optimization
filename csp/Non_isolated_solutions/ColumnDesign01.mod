...
# Instance:	01, no auxiliary variable
...
#-------------------------------------------------------------------------------
# 3 parameters; Enter your values here
#-------------------------------------------------------------------------------
param P := 400; #P >= 100, <=1000;
param H := 6; #H >= 1, <=10;
param L := 1; #L >=.1, <=5;


#-------------------------------------------------------------------------------
# 3 variables + 6 bounds
#-------------------------------------------------------------------------------
var a >=0.01, <=2; #:=0.81; #unit=meter
var b >=0.01, <=1; #:=0.69; #unit=meter
var e >=0.05, <=0.1; #:=0.05; #scale up 10 times, unit=decimeter
