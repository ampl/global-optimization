...
cons1:  x1 + x1*x2 + x2*x3 + x3*x4 -   u5 = 0;
cons2:          x2 + x1*x3 + x2*x4 - 2*u5 = 0;
cons3:                  x3 + x1*x4 - 3*u5 = 0;
cons4:                          x4 - 4*u5 = 0;
cons5:           x1 + x2 + x3 + x4 + 1 = 0;

solve;
display u5, x1, x2, x3, x4;

# TITLE : reduced 5-dimensional economics problem

# ROOT COUNTS :

# total degree : 8
# 2-homogeneous Bezout number : 12
#   with partition : {x1 x2 x3 }{x4 u5 }
...
# This is the reduced economics problem (u5 = 1/x5).
