...
cons1: x1^2-x1+x2+x3+x4+x5-10 = 0;
cons2: x2^2+x1-x2+x3+x4+x5-10 = 0;
cons3: x3^2+x1+x2-x3+x4+x5-10 = 0;
cons4: x4^2+x1+x2+x3-x4+x5-10 = 0;
cons5: x5^2+x1+x2+x3+x4-x5-10 = 0;
