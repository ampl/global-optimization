# Sorry I missed your phone call today; again I didn't get to MH til
# late.  I did get to the library for a look at Himmelblau; I found
# several errors in Hock & Schittkowski's statement of their problem 87.
# I just updated /netlib/ampl/models/nlmodels/hs87.mod to correct
# the data value for param b and add comments about the formulation.
# One other important detail now noted in the comments: hs87.mod presents
# a continuous objective whose derivatives agree with those of the
# objective stated in Himmelblau and H&S (except for being nondifferentiable
# at a few breakpoints).  I'll copy the modified problem below.
# Tonight daemons should copy it from the E-mail directory of
# netlib@netlib.bell-labs.com to the ftp directory and to other netlib
# servers.
...
param best_val_found := 8827.597735;
param eps := 88.27597735; 		# = max(1, 1% x best_val_found)

subject to loss:
    <<lim1; rate1, rate2>> x1 + <<lim2, lim3; rate3, rate4, rate5>> x2 <= best_val_found + eps;
