...
cons1:  15.0*b^4*c*d^2 + 6.0*b^4*c^3 + 21.0*b^4*c^2*d - 144.0*b^2*c
 - 8.0*b^2*c^2*e
 - 28.0*b^2*c*d*e - 648.0*b^2*d + 36.0*b^2*d^2*e + 9.0*b^4*d^3 - 120.0 = 0;
cons2:  30.0*c^3*b^4*d - 32.0*d*e^2*c - 720.0*d*b^2*c - 24.0*c^3*b^2*e
 ...
 + 24.0*d^3*b^2*e - 16.0*c^2*b^2*d*e - 240.0*c = 0;
cons3:  216.0*d*b^2*c - 162.0*d^2*b^2 - 81.0*c^2*b^2 + 5184.0 + 1008.0*e*c 
 - 1008.0*d*e
 + 15.0*c^2*b^2*d*e - 15.0*c^3*b^2*e - 80.0*d*e^2*c + 40.0*d^2*e^2 
 + 40.0*e^2*c^2 = 0;
cons4:  261.0 + 4.0*d*b^2*c - 3.0*d^2*b^2 - 4.0*c^2*b^2 + 22.0*e*c - 22.0*d*e = 0;
