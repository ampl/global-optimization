...
cons1:  w0 + w1 + w2 + w3 - 1 = 0;
cons2:  w0*b + w1*b + w2*b + w3*b + 1/2*w1 + w2 + 3/2*w3 - 0.63397459621556 = 0;
cons3:  w0*b^2 + w1*b^2 + w2*b^2 + w3*b^2 
                             + w1*b + 2*w2*b + 3*w3*b + 1/4*w1 + w2 + 9/2*w3
 - 0.40192378864668 = 0;
cons4:  w0*b^3 + w1*b^3 + w2*b^3 + w3*b^3 
                             + 3/2*w1*b^2 + 3*w2*b^2 + 9/2 *w3*b^2 
                             + 3/4*w1*b    + 3*w2*b    + 27/4*w3*b
                             + 1/8*w1      +   w2      + 27/8*w3
 - 0.13109155679036 = 0;
cons5:  w0*b^4 + w1*b^4 + w2*b^4 + w3*b^4 
